...
A user has selected a set of Governance, Risk and Compliance (GRC) documents and has asked a question about them. \
The Governance, Risk and Compliance (GRC) documents have the following titles:
{doc_titles}
